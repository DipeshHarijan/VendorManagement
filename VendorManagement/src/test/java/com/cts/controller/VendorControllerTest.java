...
public class VendorControllerTest {
	...
	public void getAllTest() throws Exception {
		when(vendorService.getAll())
				.thenReturn(Arrays.asList(new Vendor(1, "Vendor1", "City1", "8272828873", "vendor@gmail.com")));
	...
	public void getVendorByIdTest() throws Exception {
		when(vendorService.getVendorById(1))
				.thenReturn(new Vendor(1, "Vendor1", "City1", "8272828873", "vendor@gmail.com"));
	...
	public void addVendorTest() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.post("/vendor/add").accept(MediaType.APPLICATION_JSON).content(
				"{\"vendorId\":1000, \"vendorName\": \"Ravi\", \"city\": \"Mirpur\", \"mobileNo\": \"9999999999\", \"emailId\": \"ravi@gmail.com\"}")
	...
	public void updateVendorTest() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.put("/vendor").accept(MediaType.APPLICATION_JSON).content(
				"{\"vendorId\":1000, \"vendorName\": \"Ravi\", \"city\": \"Mirpur\", \"mobileNo\": \"9999999999\", \"emailId\": \"ravi@gmail.com\"}")
				.contentType(MediaType.APPLICATION_JSON);
	...
	public void deleteVendorTest() throws Exception {
		// when(vendorService.getVendorById(1)).thenReturn(new
		// Vendor(1,"Vendor1","City1","8272828873","vendor@gmail.com"));
		// doNothing().when(vendorService.deleteVendor(1));

		RequestBuilder request = MockMvcRequestBuilders.delete("/vendor/delete/{vendorId}", 1);
